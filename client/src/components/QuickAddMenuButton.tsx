...
const QuickAddMenuButton: FC<Props> = () => {
      ...
      <Dropdown>
        ...
        <DropdownMenu aria-label="Profile Actions" variant="flat">
          <DropdownItem
            ...
            startContent={<AddImageIcon width={42} height={42} color={theme === 'dark' ? '#fff' : '#1C274C'} />}
          >
            New Image
          </DropdownItem>
          <DropdownItem
            ...
            startContent={<UploadImageIcon width={42} height={42} color={theme === 'dark' ? '#fff' : '#1C274C'} />}
          >
            Upload Image
          </DropdownItem>
          <DropdownItem
...
export default QuickAddMenuButton
